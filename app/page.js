...
const PROJECTS = [
  ...
  },
  {
    ...
    emoji: "⚡",
    heroImage: null,
    role: "Puckboard Logging SME (cross-functional team) · Collaborated with iOS engineers, web engineers, and product designers across multiple product teams",
    contributions: [
  ...
  },
  {
    ...
    links: [
      ...
      {
        label: "Pearson AI Study Tool ↗",
        url: "https://www.pearson.com/en-us/higher-education/products-services/aistudytool.html",
      },
    ],
    artifacts: [
      {
        src: "https://images.squarespace-cdn.com/content/v1/611298f29aedd7131a46a751/1628648577389-UFXAFOM1627TRP35GVTC/image-asset.jpeg",
        caption: "Persona Cards — built to match Aida brand palette",
      },
      {
        src: "https://images.squarespace-cdn.com/content/v1/611298f29aedd7131a46a751/1628648636868-BCCY0C9WE8CMOAVAACTC/image-asset.png",
        caption: "Diagnostic Redesign — state clarity via grayscale and tags",
      },
      {
        src: "https://images.squarespace-cdn.com/content/v1/611298f29aedd7131a46a751/1628648672017-VDT997NSQZ2BY0CC8229/home+-+return.png",
        caption: "Homepage Refresh — personalized tutor experience",
      },
      {
        src: "https://images.squarespace-cdn.com/content/v1/611298f29aedd7131a46a751/1628648909788-AOCXWO9JKTJLAP57Y26Y/home+-+return+%281%29.png",
        caption: "Calculator Prototype — incorporated into Pearson roadmap",
      },
      {
          ...
          >
            {project.phases.map((p, i) => (
              <button
                ...
                onFocus={(e) => {
                  e.target.style.boxShadow = `0 0 0 2px ${project.color}66`;
                }}
                onBlur={(e) => {
            ...
            >
              {project.links.map((link, i) => (
                <a
                  ...
                  onMouseLeave={(e) => {
                    e.currentTarget.style.background = project.color + "0d";
...
function EasterEggModal({ onClose, onMaster, caught, setCaught }) {
  ...
  useEffect(() => {
    ...
    fetch(url)
        ...
        if (sprite) {
          return fetch(sprite)
            ...
            .then((blob) => {
              ...
              reader.onload = () => {
                if (!cancelled) setSpriteData(reader.result);
              };
      ...
      .catch(() => {
        if (!cancelled) setSpriteData("error");
      });
    return () => {
      cancelled = true;
    };
      ...
      >
        ...
        <button
          ...
          style={{
            ...
            letterSpacing: "0.08em",
            padding: "12px 32px",
            cursor: wasAlreadyCaught || throwing ? "default" : "pointer",
            marginBottom: "24px",
            width: "100%",
            transition: "all 0.15s",
            display: "flex",
