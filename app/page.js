    ...
    <section id="contact" aria-label="Contact" style={{ padding: "100px 48px", borderTop: "1px solid #111", background: "#080809" }}>
      <div style={{ maxWidth: "700px" }}>
        ...
        <div style={{ display: "flex", gap: "16px", flexWrap: "wrap" }}>
          ...
          <a href="/Henning_Resume.docx.pdf" target="_blank" rel="noreferrer" style={{ border: "1px solid #333", color: "#fff", fontFamily: "'DM Mono', monospace", fontSize: "12px", letterSpacing: "0.1em", textTransform: "uppercase", padding: "14px 28px", borderRadius: "4px", textDecoration: "none", transition: "all 0.15s" }}
