      ...
      <div style={{ display: "flex", gap: mobile ? "16px" : "32px", alignItems: "center" }}>
        ...
        <button
          ...
          style={{
            ...
            color: eggFound ? "#facc15" : "#333", cursor: "pointer",
...
function EasterEggModal({ onClose }) {
  ...
  const [current, setCurrent] = useState(() => POKEMON[Math.floor(Math.random() * POKEMON.length)]);
      ...
      <div onClick={e => e.stopPropagation()} style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            {/* Pokéball closing animation overlay */}
            {catchAnim && (
              <div style={{
                position: "absolute", inset: 0,
                display: "flex", alignItems: "center", justifyContent: "center",
...
export default function App() {
  ...
  return (
    <>
      <style>{`
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        @keyframes pokeballDrop {
          ...
          65%  { transform: translateY(0) scale(0.95); opacity: 1; }
      ...
      {showEgg && (
        <EasterEggModal onClose={() => setShowEgg(false)} />
      )}
    </>
  );
}
