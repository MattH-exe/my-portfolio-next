...
const PROJECTS = [
  {
    ...
    artifacts: [
      { src: "https://images.squarespace-cdn.com/content/v1/611298f29aedd7131a46a751/15b3ac58-8fd8-4989-9ff6-5f666181cac8/Case+Study+Template_Page_01.jpg", caption: "Puckboard Logging — case study overview" },
    ...
    phases: [
      {
        ...
        callout: { type: "quote", text: "\"We spend more time on paperwork after a flight than we do on the actual debrief.\"", attr: "— F/A-18 Pilot, contextual interview" },
      },
      {
        phase: "02 — Define",
        ...
        callout: { type: "stat", stats: [{ v: "14", l: "Manual steps in old flow" }, { v: "3+", l: "Systems touched per mission" }, { v: "0", l: "Automated validation checks" }] },
      },
      {
        phase: "03 — Ideate",
        ...
        callout: { type: "principles", items: ["Progressive disclosure", "Offline-first architecture", "One-handed interaction model", "Data pre-population from scheduling"] },
      },
      {
        ...
        callout: { type: "quote", text: "\"This is the first piece of software I've used that actually understands how we work.\"", attr: "— Naval Aviator, usability test session" },
      },
      {
        phase: "05 — Deliver",
        ...
        callout: { type: "stat", stats: [{ v: "65%", l: "Task time reduction" }, { v: "$20M+", l: "Operational savings" }, { v: "375K hrs", l: "Reclaimed annually" }] },
      },
    ],
    ...
    phases: [
      {
        ...
        callout: { type: "stat", stats: [{ v: "3", l: "Products audited" }, { v: "0", l: "Shared design tokens" }, { v: "0", l: "Documented component standards" }] },
      },
      {
        ...
        callout: { type: "principles", items: ["Match iOS visual weight & spacing rhythm", "Replicate interaction feel, not pixel accuracy", "Shared semantic color tokens across platforms", "Document the 'why' behind every translation decision"] },
      },
      {
        phase: "03 — Build",
        ...
        callout: { type: "stat", stats: [{ v: "42+", l: "Core components" }, { v: "100%", l: "State coverage" }, { v: "iOS-mapped", l: "Every web component" }] },
      },
      {
        phase: "04 — Deliver",
        ...
        callout: { type: "quote", text: "\"Nimbus cut our design review cycle in half. The answers are already in the system.\"", attr: "— Senior Engineer, post-adoption review" },
      },
    ],
    tags: ["Design Systems", "Figma", "Storybook", "Iconography", "Documentation", "iOS"],
  },
  {
    id: "parkpal",
    year: "2022",
  ...
  },
  {
    ...
    phases: [
      {
        ...
        callout: { type: "quote", text: "\"I know what the answer looks like in my head. I just can't figure out how to type it.\"", attr: "— Calculus student, discovery interview" },
      },
      {
        phase: "02 — Define",
        ...
        callout: { type: "principles", items: ["Handwriting as the primary input modality", "Immediate feedback — no waiting for tutor response", "Scaffolded hints over direct answers", "Familiar notebook metaphor for UI"] },
      },
      {
        phase: "03 — Prototype",
    ...
    tags: ["AI/OCR", "EdTech", "iOS", "Service Blueprinting", "Prototyping", "Pearson"],
  },
  {
    id: "pbt",
    year: "2025–Present",
    ...
    phases: [
      {
        ...
        callout: { type: "quote", text: "\"I'm spending half my week just trying to figure out who has done what. The actual coordination is almost secondary.\"", attr: "— Test coordinator, discovery interview" },
      },
      {
        phase: "02 — Define",
        ...
        callout: { type: "principles", items: ["Single source of truth for all test status", "Role-appropriate views — individual vs. coordinator", "Exception and waiver workflows built in", "Exportable reporting for command review"] },
      },
      {
        phase: "03 — Design",
        ...
        callout: { type: "stat", stats: [{ v: "🔄", l: "Research ongoing" }, { v: "🔄", l: "Wireframes in progress" }, { v: "🔄", l: "Testing planned" }] },
      },
    ],
...
function Nav({ onEasterEgg, eggFound, isMaster }) {
  ...
  return (
    <nav aria-label="Main navigation" style={{
      ...
      padding: mobile ? "16px 20px" : "20px 48px", borderBottom: "none",
      background: "transparent",
    }}>
      <div style={{ display: "flex", alignItems: "center", gap: "8px", flexShrink: 0 }}>
        <span aria-label="Matthew W. Henning" style={{
          fontFamily: "'Bebas Neue', sans-serif",
          fontSize: "22px", letterSpacing: "0.08em", color: "#fff",
        }}>MWH</span>
      ...
      <div style={{ display: "flex", gap: mobile ? "16px" : "32px", alignItems: "center" }}>
        {!mobile && ["Work", "About", "Contact"].map(link => (
          <a key={link} href={`#${link.toLowerCase()}`} style={{
            ...
            color: "#666", textDecoration: "none", letterSpacing: "0.08em",
        ...
        <button
          ...
          style={{
            ...
            cursor: "pointer",
            padding: "6px 10px", fontSize: "14px", lineHeight: "1",
  ...
  return (
    <section aria-label="Introduction" style={{ padding: "100px 48px 80px", maxWidth: "1200px", background: "transparent" }}>
      <p style={{
        ...
        color: "#10b981", letterSpacing: "0.2em", textTransform: "uppercase",
        marginBottom: "28px",
      }}>
  ...
  return (
    <article
      ...
      style={{
        ...
        boxShadow: hovered ? `0 20px 60px rgba(0,0,0,0.5), 0 0 0 1px ${project.color}22` : "none",
    ...
    >
      ...
      <div style={{
        ...
        <span style={{
          fontFamily: "'Bebas Neue', sans-serif",
          fontSize: "32px", color: project.color, letterSpacing: "0.04em",
        }}>{project.impact}</span>
        <span style={{
          fontFamily: "'DM Mono', monospace",
...
function Callout({ callout, color }) {
  ...
  if (callout.type === "quote") return (
    <div style={{
      borderLeft: `3px solid ${color}`, paddingLeft: "20px",
      margin: "20px 0", background: color + "08", borderRadius: "0 8px 8px 0",
      padding: "16px 20px",
    }}>
      <p style={{
        fontFamily: "'Inter', sans-serif", fontSize: "15px",
        color: "#ccc", lineHeight: "1.6", marginBottom: "8px",
      }}>{callout.text}</p>
      <span style={{
        fontFamily: "'DM Mono', monospace", fontSize: "10px",
  ...
  if (callout.type === "stat") return (
    <div style={{
      display: "flex", gap: "12px", margin: "20px 0", flexWrap: "wrap",
    }}>
      {callout.stats.map((s, i) => (
        <div key={i} style={{
          ...
          <div style={{
            ...
            color: color, letterSpacing: "0.04em", lineHeight: "1",
          }}>{s.v}</div>
          <div style={{
            fontFamily: "'DM Mono', monospace", fontSize: "9px",
            color: "#666", letterSpacing: "0.08em", marginTop: "4px",
            textTransform: "uppercase",
          }}>{s.l}</div>
        </div>
      ))}
  ...
  if (callout.type === "principles") return (
    <div style={{
      display: "flex", flexWrap: "wrap", gap: "8px", margin: "20px 0",
    }}>
      {callout.items.map((item, i) => (
        <span key={i} style={{
          fontFamily: "'DM Mono', monospace", fontSize: "10px",
          color: color, background: color + "10",
          border: `1px solid ${color}30`, borderRadius: "100px",
    ...
    >
      <button
        ...
        style={{
          ...
          color: "#aaa", cursor: "pointer", borderRadius: "8px",
      ...
      <p style={{
        fontFamily: "'DM Mono', monospace", fontSize: "10px",
        color: "#333", letterSpacing: "0.08em", marginTop: "8px",
  ...
  useEffect(() => {
    ...
    const handler = (e) => {
      ...
      if (e.key === "ArrowRight" || e.key === "ArrowDown") {
        ...
        next.focus();
        setActivePhase((idx + 1) % chips.length);
      }
      if (e.key === "ArrowLeft" || e.key === "ArrowUp") {
        e.preventDefault();
        const prev = chips[(idx - 1 + chips.length) % chips.length];
        prev.focus();
        setActivePhase((idx - 1 + chips.length) % chips.length);
      }
    };
    window.addEventListener("keydown", handler);
    return () => {
  ...
  return (
    <div
      ...
      <div
        ...
        style={{
        background: "#0e0e12", border: `1px solid ${project.color}44`,
        borderRadius: "16px", width: "100%", maxWidth: "920px",
            ...
            <div>
              <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "6px" }}>
                ...
                {project.wip && (
                  ...
                  }}>● Work in Progress — Case study being documented as design develops</span>
                )}
              </div>
              <h2 style={{
                fontFamily: "'Bebas Neue', sans-serif",
                fontSize: "clamp(36px, 5vw, 56px)", fontWeight: "400", lineHeight: "1",
                color: "#fff", letterSpacing: "0.02em",
              }}>{project.title}</h2>
            </div>
            <button onClick={onClose} aria-label="Close case study" style={{
              background: "#1a1a1a", border: "1px solid #2a2a2a",
              color: "#888", cursor: "pointer", borderRadius: "8px",
              width: "36px", height: "36px", fontSize: "18px",
              display: "flex", alignItems: "center", justifyContent: "center",
        ...
        <div style={{ padding: mobile ? "20px 20px 36px" : "28px 36px 44px" }}>
          ...
          <div style={{
            ...
            {project.metrics.slice(0, mobile ? 3 : project.metrics.length).map((m, i) => (
              <div key={i} style={{
                ...
                <div style={{
                  ...
                  color: project.color, letterSpacing: "0.04em", lineHeight: "1",
                }}>{m.value}</div>
                <div style={{
                  fontFamily: "'DM Mono', monospace", fontSize: "9px",
                  color: "#555", letterSpacing: "0.08em", marginTop: "4px",
                  textTransform: "uppercase",
                }}>{m.label}</div>
              </div>
            ))}
            ...
            {project.phases.map((p, i) => (
              <button
                ...
                style={{
                  ...
                  background: i === activePhase ? project.color + "18" : "transparent",
          ...
          <div style={{
            ...
            <p style={{
              fontFamily: "'Inter', sans-serif",
              fontSize: "15px", color: "#c8c8c8", lineHeight: "1.65",
              marginBottom: "4px",
            }}>{phase.body}</p>
          ...
          <div style={{
            ...
            <button
              ...
              style={{
                ...
                background: "none", border: "none", cursor: activePhase === 0 ? "default" : "pointer",
                letterSpacing: "0.08em",
              }}>← Prev</button>
            <span style={{
              fontFamily: "'DM Mono', monospace", fontSize: "10px",
              color: "#333", letterSpacing: "0.1em",
            }}>{activePhase + 1} / {project.phases.length}</span>
            <button
              onClick={() => setActivePhase(Math.min(project.phases.length - 1, activePhase + 1))}
              disabled={activePhase === project.phases.length - 1}
              aria-label="Next phase"
              style={{
                fontFamily: "'DM Mono', monospace", fontSize: "11px",
                color: activePhase === project.phases.length - 1 ? "#2a2a2a" : project.color,
                background: "none", border: "none",
                cursor: activePhase === project.phases.length - 1 ? "default" : "pointer",
                letterSpacing: "0.08em",
              }}>Next →</button>
          </div>
            ...
            <div style={{ marginTop: "28px", paddingTop: "24px", borderTop: "1px solid #1a1a1a" }}>
              ...
              <div style={{
                ...
                {project.artifacts.map((artifact, i) => (
                  <button
                    key={i}
                    onClick={() => setLightbox({ src: artifact.src, caption: artifact.caption })}
                    aria-label={`View larger: ${artifact.caption}`}
                    style={{
  ...
  return (
    <div onClick={onClose} style={{
      ...
      <div onClick={e => e.stopPropagation()} style={{
        background: "#0a0a12", border: "2px solid #facc15",
        ...
        <div style={{
          ...
          <div style={{
            ...
            {!animDone && (
              <div style={{
                ...
                display: "flex", alignItems: "center", justifyContent: "center",
                animation: catchAnim
                  ? "catchShrink 0.9s ease forwards"
                  : shaking
                ...
                {wasAlreadyCaught ? (
                  ...
                  <img
                    src={spriteData}
                    alt={current.name}
                    style={{ width: "96px", height: "96px", objectFit: "contain", imageRendering: "auto" }}
                  />
                ) : spriteData === "error" ? (
                  <span style={{ fontSize: "64px" }}>❓</span>
                ) : (
                  <span style={{ fontFamily: "'DM Mono', monospace", fontSize: "11px", color: "#444" }}>loading...</span>
                )}
              </div>
            )}
            ...
            {catchAnim && (
              <div style={{
                position: "absolute", inset: 0,
                display: "flex", alignItems: "center", justifyContent: "center",
                animation: "pokeballDrop 0.9s ease forwards",
                fontSize: "72px",
                zIndex: 2,
              }}>⭐</div>
            )}
          ...
          <div style={{
            fontFamily: "'Bebas Neue', sans-serif",
            fontSize: "32px", color: "#fff", letterSpacing: "0.04em",
          }}>{current.name}</div>
          <div style={{
            fontFamily: "'DM Mono', monospace", fontSize: "11px",
        ...
        <button onClick={onClose} style={{
          ...
          fontFamily: "'DM Mono', monospace", fontSize: "11px",
          cursor: "pointer", marginTop: "16px", letterSpacing: "0.08em",
        }}>[ close ]</button>
      </div>
    </div>
  );
    ...
    <section id="contact" aria-label="Contact" style={{
      ...
      <div style={{ maxWidth: "700px" }}>
        ...
        <div style={{ display: "flex", gap: "16px", flexWrap: "wrap" }}>
          ...
          onMouseLeave={e => { e.target.style.background = "#fff"; e.target.style.color = "#000"; }}
          >Email Me →</a>
          <a href="https://linkedin.com/in/matthew-henning" target="_blank" rel="noreferrer" style={{
            border: "1px solid #333", color: "#fff",
            fontFamily: "'DM Mono', monospace", fontSize: "12px",
            letterSpacing: "0.1em", textTransform: "uppercase",
            padding: "14px 28px", borderRadius: "4px",
          ...
          onMouseLeave={e => { e.target.style.borderColor = "#333"; }}
          >LinkedIn</a>
          <a href="https://www.matthenning.me/s/MATTHEW-HENNING-RESUME-2.pdf" target="_blank" rel="noreferrer" style={{
            border: "1px solid #333", color: "#fff",
            fontFamily: "'DM Mono', monospace", fontSize: "12px",
            letterSpacing: "0.1em", textTransform: "uppercase",
            padding: "14px 28px", borderRadius: "4px",
