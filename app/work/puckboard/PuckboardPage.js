    ...
    <>
      ...
      <main style={{ maxWidth: "1400px", margin: "0 auto" }}>
        ...
        <section aria-label="Puckboard overview" style={{ padding: "80px clamp(16px, 3vw, 36px) 40px" }}>
          ...
          <div style={{ fontFamily: FONTS.mono, fontSize: "10px", color: "#00d4ff", letterSpacing: "0.2em", textTransform: "uppercase", marginBottom: "12px" }}>120+ Scheduling Units ✦ 10,000+ Daily Active Users ✦ 12 Airframes</div>
